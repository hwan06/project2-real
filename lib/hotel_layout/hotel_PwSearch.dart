...
import 'package:flutter_application_hotel/hotel_layout/hotel_PwConfirm.dart';
import 'package:http/http.dart' as http;
import 'package:flutter_application_hotel/api/hotel_api.dart';

class hotel_pw_search extends StatefulWidget {
  const hotel_pw_search({super.key});

  @override
  State<hotel_pw_search> createState() => _hotel_pw_searchState();
}

class _hotel_pw_searchState extends State<hotel_pw_search> {
  String id = "";
  String pw = "";
  ...
  emailAuth() async {
    try {
      var res = await http.post(Uri.parse(HotelApi.emailVal), body: {
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => hotel_pwConfirm(
                              email: email,
                            )));
              },
            ),
