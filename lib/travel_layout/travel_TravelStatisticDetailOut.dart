...
class TravelStatisticOutDetail extends StatefulWidget {
  final String hotelID;
  const TravelStatisticOutDetail({
    super.key,
    required this.hotelID,
  });
  @override
  State<TravelStatisticOutDetail> createState() =>
      _TravelStatisticOutDetailState();
}
...
class _TravelStatisticOutDetailState extends State<TravelStatisticOutDetail> {
