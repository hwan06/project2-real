...
class travel_pwConfirm extends StatefulWidget {
  final String email;
  const travel_pwConfirm({required this.email, super.key});

  @override
  State<travel_pwConfirm> createState() => _travel_pwConfirmState();
}

class _travel_pwConfirmState extends State<travel_pwConfirm> {
  ...
  userPwUpdate() async {
    try {
      var resPw = await http.post(Uri.parse(TravelApi.pwEdit), body: {
